...
class BadHabitController {
    ...
    // Get all bad habits with pagination
    async getBadHabits(req: Request, res: Response) {
        const params =
        ...
        const [badHabits, count] = await Promise.all([
        ...
        return res.json({
            ...
            result: {
                ...
                data: {
                    count,
                    results: badHabits.map((item) => this.formatResponse(item)),
                },
            },
        });     
    }
