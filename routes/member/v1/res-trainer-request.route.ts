...
router.post("/res.trainer.request/:trainer_id/update", [
  passport.authenticate("jwt", { session: false }),
  asyncHandler(
    async (req: Request, res: Response) =>
      await memberRequestController.trainerRequestUpdate(req, res)
  ),
]);

router.post("/res.trainer.request/form-data/:trainer_id/update", [
  passport.authenticate("jwt", { session: false }),
  asyncHandler(
    async (req: Request, res: Response) =>
      await memberRequestController.trainerRequestFormDataUpdate(req, res)
  ),
]);
